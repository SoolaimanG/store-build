...
export const LandingPageFeatures: React.FC = () => {
  return (
    <main className="mt-5 w-full">
      <div className="mx-auto max-w-4xl md:px-6 px-3 md:max-w-7xl w-full lg:px-8 flex flex-col space-y-2">
        <motion.h2
        ...
        >
          <Text className="mx-auto mt-2 max-w-lg text-balance text-center text-4xl font-semibold tracking-tight sm:text-5xl text-white">
            What we provide for your business.
          </Text>
        </motion.div>
        <div className="mt-12 w-full md:grid flex flex-col gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <FeatureCard className="relative lg:row-span-2 w-full">
            <div className="absolute inset-px rounded-lg bg-slate-900 lg:rounded-l-[2rem]"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-300 max-lg:text-center">
                  Mobile friendly
                </p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-50 max-lg:text-center">
                  All templates are optimized for mobile, ensuring a smooth
                  shopping experience on any device, so your customers can shop
                  from anywhere.
                </p>
              </div>
              <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                <div className="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
                  <img
                    ...
                    src="https://i.ibb.co/hRn05wZd/Whats-App-Image-2025-02-18-at-05-47-40-cef66cc1.jpg"
                    alt=""
                  />
                </div>
              </div>
          ...
          <FeatureCard className="relative max-lg:row-start-1" delay={0.2}>
            <div className="absolute inset-px rounded-lg bg-slate-900 max-lg:rounded-t-[2rem]"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-50 max-lg:text-center">
                  Increase your store's visibility on search engines with
                  built-in SEO tools that help your products reach more
                  customers.
                </p>
              </div>
          ...
          <FeatureCard
            ...
            delay={0.4}
          >
            <div className="absolute inset-px rounded-lg bg-slate-900"></div>
          ...
          <FeatureCard className="relative lg:row-span-2" delay={0.6}>
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-50 max-lg:text-center">
                  Effortlessly create a personalized store with AI that guides
                  you through setup, design, and customization tailored to your
                  products and brand.
                </p>
              </div>
              <AIFeatures />
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-[1.5px] border-border bg-slate-300 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
function AIFeatures({ className }: { className?: string }) {
    ...
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className="flex flex-col justify-center gap-2">
          <motion.div variants={circleVariants} custom={0}>
            <Circle ref={div1Ref} className="">
              <Icons.googleDrive />
            </Circle>
          </motion.div>
          <motion.div variants={circleVariants} custom={0.1}>
            <Circle ref={div2Ref} className="">
              <Icons.googleDocs />
            </Circle>
          </motion.div>
          <motion.div variants={circleVariants} custom={0.2}>
            <Circle ref={div3Ref}>
              <Icons.whatsapp />
            </Circle>
          </motion.div>
          <motion.div variants={circleVariants} custom={0.3}>
            <Circle ref={div4Ref} className="">
              <Icons.messenger />
            </Circle>
          </motion.div>
          <motion.div variants={circleVariants} custom={0.4}>
            <Circle ref={div5Ref} className="">
              <Icons.notion />
            </Circle>
          </motion.div>
        </div>
        <div className="flex flex-col justify-center">
          <motion.div variants={circleVariants} custom={0.5}>
        ...
        <div className="flex flex-col justify-center ">
          <motion.div variants={circleVariants} custom={0.6}>
            <Circle ref={div7Ref}>
              <Icons.user />
            </Circle>
          </motion.div>
